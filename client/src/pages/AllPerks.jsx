...
export default function AllPerks() {
  ...
  // Empty dependency array → runs once on component mount (like componentDidMount)

  // ✅ #2 — Auto-search when searchQuery or merchantFilter change
  useEffect(() => {
    // Skip auto-fetch if still typing or values are empty right after reset
    const debounceTimer = setTimeout(() => {
      loadAllPerks();
    }, 500); // waits 500ms after user stops typing

    // Cleanup function: cancels timer if user keeps typing
